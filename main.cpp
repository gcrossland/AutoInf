    ...
    unordered_map<HashWrapper<string<char>>, Story> stories = {
      ...
      {HashWrapper<string<char>>("advent"), {{
        ...
        vector<ActionSet::Word> {
          ...
          {u8("hill"), noun | supporter | flammable},
          {u8("other side of hill"), noun | supporter | flammable},
          {u8("spring"), noun | container | edible},
          {u8("pipes"), noun | container | openable},
          ...
          {u8("snake"), noun | holdable | animate | flammable},
          ...
          {u8("marks"), noun},
          {u8("shadowy figure"), noun | animate | flammable},
          {u8("rocks"), noun | mobile | holdable | supporter},
          {u8("orange column"), noun | supporter | flammable},
          ...
          {u8("thin rock slabs"), noun | mobile | holdable | supporter | openable},
          ...
          {u8("trident"), noun | mobile | holdable | flammable},
          {u8("carpet"), noun | supporter | flammable},
          {u8("curtains"), noun | holdable | openable | flammable},
          {u8("moss"), noun | mobile | holdable},
          {u8("pillow"), noun | mobile | holdable | supporter | openable},
          {u8("drawings"), noun | mobile | holdable | readable | flammable},
          ...
          {u8("troll"), noun | animate | flammable},
        ...
        vector<ActionSet::Template> {
          ...
          {u8("throw "), holdable, u8(" at "), noun, u8("\n")},
          {u8("feel "), noun, u8("\n")},
          {u8("wake up\n")},
